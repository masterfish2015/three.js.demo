...
function _draw_pcb_overlay_arc (arc) {
  ...
  let x1 = x + (r - width / 2) * cos_start_ang,
    x2 = x + (r + width / 2) * cos_start_ang,
    x3 = x + (r - width / 2) * cos_end_ang,
    x4 = x + (r + width / 2) * cos_end_ang,
    y1 = y + (r - width / 2) * sin_start_ang,
    y2 = y + (r + width / 2) * sin_start_ang,
    y3 = y + (r - width / 2) * sin_end_ang,
    y4 = y + (r + width / 2) * sin_end_ang

  shape.moveTo(x1, y1)
  shape.lineTo(x2, y2)
  shape.absarc(x, y, r + width / 2, start_angle * Math.PI / 180, end_angle * Math.PI / 180, false)
  //_draw_shape_arc(shape, x, y, r + width / 2, start_angle* Math.PI / 180, end_angle* Math.PI / 180)
  shape.lineTo(x3, y3)
  shape.absarc(x, y, r - width / 2, end_angle * Math.PI / 180, start_angle * Math.PI / 180, false)
  //_draw_shape_arc(shape, x, y, r - width / 2, end_angle* Math.PI / 180, start_angle* Math.PI / 180)
  // shape.lineTo(x+x2, y+y2)
